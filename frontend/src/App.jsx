...
/* ================================
   CONFIG
================================ */
const API_BASE = 'https://smart-hire-ai-portal-2-52o9.onrender.com/api/';
...
export default function App() {
  ...
  async function submitApplication() {
    ...
    try {
      ...
      if (!applyRes.ok) {
        const errText = await applyRes.text().catch(() => 'Upload failed');
        throw new Error(`Server returned ${applyRes.status}: ${errText}`);
      }
